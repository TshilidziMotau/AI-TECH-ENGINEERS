...
import { Activity, Building2, Calculator, Mountain, Radar, Route, ScanLine, Waves } from "lucide-react";
...
const services = [
  ...
  { icon: Route, title: "Road Design Support", copy: "Corridor mapping and longitudinal surface intelligence for route alignment and grading plans.", benefit: "Reduce redesign risk with terrain-accurate road design inputs." },
  { icon: Calculator, title: "Quantity Surveying (QS)", copy: "Volumetric and measurement workflows for cut/fill, stockpiles, and progress-based valuation.", benefit: "Improve cost control with auditable site quantities." },
];
